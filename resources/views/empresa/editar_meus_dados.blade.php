                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <form id="formEditarMeusDadosEmpresa" method="POST" action="{{ route('atualizar.gerente') }}">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4"  style="padding-right:15px;">
                                    ...
                                    <input id="idNomeDoUsuarioEditarDados" type="text" class="styleInputCadastro" name="name" placeholder="" value="{{$nome}}">
                                </div>
                                <div class="form-group col-md-4"  style="padding-right:15px;">
                                    <label class="styleTituloDoInputCadastro" for="inputEmail4">E-mail:</label>
                                    <input type="text" class="styleInputCadastro" placeholder="" value="{{$email}}" disabled>
                                </div>
                            </div>
                        <form>
                        <hr size = 7>
                        <div style="margin-bottom:0.2rem;">
                                ...
                                <div class="col-md-4">
                                    <button type="button" class="btn btn-success" style="width:100%;" onclick="abrirModalMeusDadosEmpresa('{{$nome}}',idNomeDoUsuarioEditarDados)">Atualizar</button>
                                </div>
                            </div>
                        </div>
                    </div>
