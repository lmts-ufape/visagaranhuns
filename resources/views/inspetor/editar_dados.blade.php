                    ...
                    <div class="form-group col-md-12">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                @endif
                                <label style="font-size:19px;margin-top:10px; margin-bottom:-5px; font-family: 'Roboto', sans-serif;">DADOS DO INSPETOR</label>
                            </div>
                        </div>
                        <form id="formEditarMeusDadosInspetor" method="POST" action="{{ route('atualizar.dados.inspetor') }}">
                            @csrf
                            <div class="form-row">
                                <div class="form-group col-md-4"  style="padding-right:15px;">
                                    ...
                                    <input id="idNomeDoUsuarioEditarDados" type="text" class="styleInputCadastro" name="name" placeholder="" value="{{$nome}}" required>
                                </div>
                                <div class="form-group col-md-4"  style="padding-right:15px;">
                                    <label class="styleTituloDoInputCadastro" for="inputCpfl4">Cpf:<span style="color:red">*</span></label>
                                    <input type="text" class="styleInputCadastro" placeholder="" name="cpf" value="{{$cpf}}" required>
                                </div>
                                <div class="form-group col-md-4"  style="padding-right:15px;">
                                    <label class="styleTituloDoInputCadastro" for="inputFormacao4">Formação:</label>
                                    <input type="text" class="styleInputCadastro" placeholder="" name="formacao" value="{{$formacao}}">
                                </div>
                                <div class="form-group col-md-4"  style="padding-right:15px;">
                                    <label class="styleTituloDoInputCadastro" for="inputEspecializacao4">especialização:</label>
                                    <input type="text" class="styleInputCadastro" placeholder="" name="especializacao" value="{{$especializacao}}">
                                </div>
                                <div class="form-group col-md-4"  style="padding-right:15px;">
                                    <label class="styleTituloDoInputCadastro" for="inputTelefone4">Telefone:<span style="color:red">*</span></label>
                                    <input type="text" class="styleInputCadastro" placeholder="" name="telefone" value="{{$telefone}}" required>
                                </div>
                            </div>
                        <form>
                        <hr size = 7>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color:#2a9df4;">
                    <img src="{{ asset('/imagens/logo_atencao3.png') }}" alt="Logo" style=" margin-right:15px;"/><h5 class="modal-title" id="exampleModalLabel" style="font-size:20px; color:white; font-weight:bold; font-family: 'Roboto', sans-serif;">Atualizar Dados</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12" style="font-family: 'Roboto', sans-serif;">Tem certeza de que deseja alterar estes dados <label id="nomeDoEstabelecimento" style="font-weight:bold; font-family: 'Roboto', sans-serif;"></label>?</div>
...
<script type="text/javascript">
    function myFunction(){
        document.getElementById("formEditarMeusDadosInspetor").submit();
    }
</script>
