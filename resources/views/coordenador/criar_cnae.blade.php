        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="mr-auto p-2 styleBarraPrincipalPC">
                <div class="form-group">
                    <div class="tituloBarraPrincipal">Cadastrar Cnae</div>
                    <div>
                        <div style="margin-left:10px; font-size:13px;margin-top:2px; margin-bottom:-15px;color:gray;">Início > Áreas > CNAE > Cadastrar Cnae</div>
                    </div>
                </div>
            </div>
            <div class="p-2">
            ...
            <div class="container" style="margin-top:1rem;">
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <form id="formCadastrarArea" method="POST" action="{{ route('cadastrar.cnae') }}">
                            @csrf
                            <div class="form-row">
                                <div class="form-group col-md-4"  style="padding-right:15px;">
                                    ...
                                    <input type="text" class="styleInputCadastro" name="codigo" id="nomeArea" placeholder="7 Digitos" minlength="7" maxlength="7" required>
                                </div>
                                <div class="form-group col-md-4"  style="padding-right:15px;">
                                    <label class="styleTituloDoInputCadastro" for="inputEmail4">Descrição do novo cnae:<span style="color:red">*</span></label>
                                    <input type="text" class="styleInputCadastro" name="descricao" id="nomeArea" placeholder="" required="required">
                                </div>
                                <div class="form-group col-md-4"  style="padding-right:15px;">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color:#2a9df4;">
                    <img src="{{ asset('/imagens/logo_atencao3.png') }}" alt="Logo" style=" margin-right:15px;"/><h5 class="modal-title" id="exampleModalLabel" style="font-size:20px; color:white; font-weight:bold; font-family: 'Roboto', sans-serif;">Cadastrar Cnae</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12" style="font-family: 'Roboto', sans-serif;">Tem certeza de que deseja cadastrar esse cnae <label id="nomeDoEstabelecimento" style="font-weight:bold; font-family: 'Roboto', sans-serif;"></label>?</div>
