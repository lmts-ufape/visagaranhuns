    ...
    <form action="">
        <div class="container" style="margin-top:1rem;margin-left:10px;">
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    <label for="inputPassword4">CNAE:<span style="color:red">*</span></label>
                    <input type="text" class="form-control"  name="cnae" placeholder="">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="inputEmail4">E-mail do estabelecimento:</label>
                    <input type="email" class="form-control" name="emailEstabelecimento" placeholder="">
                </div>
                <div class="form-grtextoup col-md-4">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="telefone1" placeholder="">
                        </div>
                    </div>
                </div>
                <div class="form-group col-md-4">
        ...
        <div class="container" style="margin-top:1rem;margin-left:10px;">
            ...
            <div class="form-row" style="padding-bottom:1.5rem;">
                ...
                <div class="form-group col-md-4">
                        <label for="inputEmail4">Cidade/UF:<span style="color:red">*</span></label>
                <input type="text" class="form-control" name="cidadeuf" placeholder="">
                    </div>
                <div class="form-group col-md-4">
            ...
            <div class="container" style="margin-top:1rem;margin-left:10px;">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="email" class="form-control" name="emailGerente" placeholder="">
                    </div>
                    <div class="form-group col-md-4">
