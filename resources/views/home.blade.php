    ...
    @auth
        @if (auth()->user()->tipo == "coordenador")
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">{{ __('Cadastro de Fiscal') }}</div>
        
                        <div class="card-body">
                            <form method="POST" action="{{ route('cadastrar.fiscal') }}">
                                @csrf
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('cadastro.fiscal') }}">
                                @csrf
