                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th class="subtituloBarraPrincipal" style="font-size:15px; color:black">{{$item->motivo}}</th>
                                    ...
                                    @endif
                                        ...
                                        {{-- <th class="subtituloBarraPrincipal" style="font-size:15px; color:black">Notifica</th> --}}
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
...
<script type="text/javascript">
    ...
    window.notificacoes = function($id){        
        $.ajax({
            url:'{{ config('prefixo.PREFIXO') }}estabelecimento/encontrar/notificacoes/rt',
            type:"get",
            dataType:'json',
            data: {"id": $id},
