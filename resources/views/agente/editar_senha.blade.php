                    ...
                    <div class="form-group col-md-12">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                @endif
                                <label style="font-size:19px;margin-top:10px; margin-bottom:-5px; font-family: 'Roboto', sans-serif;">SENHA DO AGENTE</label>
                            </div>
                        </div>
                        <form id="formEditarSenhaInspetor" method="POST" action="{{ route('atualizar.senha.agente') }}">
                            @csrf
                            <div class="form-row">
